...
**<?php echo new \Illuminate\Support\EncodedHtmlString($formName); ?>** on **<?php echo new \Illuminate\Support\EncodedHtmlString($websiteName); ?>** received a new submission on <?php echo new \Illuminate\Support\EncodedHtmlString($submittedAt); ?>.
...
| <?php echo new \Illuminate\Support\EncodedHtmlString($row['label']); ?> | <?php echo new \Illuminate\Support\EncodedHtmlString($row['value']); ?> |
...
Submission #<?php echo new \Illuminate\Support\EncodedHtmlString($submissionId); ?> — open the CMS admin under **Forms → Submissions** to manage it.
...
<?php endif; ?>
<?php /**PATH D:\ClaudeProjects\CMSWebsite\backend\resources\views/mail/form-submission.blade.php ENDPATH**/ ?>