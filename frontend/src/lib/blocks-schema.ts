...
export const BLOCK_DEFS: BlockDef[] = [
  {
    ...
    fields: [
      ...
      { path: "heading", label: "Heading — wrap *words* to accent them", type: "text" },
      { path: "tagline", label: "Tagline (accent line under the heading)", type: "text" },
      ...
      ...ctaFields(),
      { path: "cta.icon", label: "Button icon (emoji)", type: "text", placeholder: "📞" },
      { path: "cta2.label", label: "Second button text", type: "text" },
      { path: "cta2.url", label: "Second button link", type: "url" },
      { path: "banner.label", label: "Banner label (small caps)", type: "text", placeholder: "Available now" },
      { path: "banner.title", label: "Banner title", type: "text" },
      { path: "banner.links", label: "Banner links — one per line: Label|https://…", type: "textarea" },
      { path: "banner.cta.label", label: "Banner button text", type: "text" },
      { path: "banner.cta.url", label: "Banner button link", type: "url" },
      {
        path: "settings.align",
        label: "Alignment",
        type: "select",
    ...
    repeater: {
      path: "proof",
      label: "Proof cards (glass)",
      itemLabel: "card",
      titleField: "value",
      fields: [
        { key: "value", label: "Headline number", type: "text", placeholder: "2,500+" },
        { key: "label", label: "Label", type: "text", placeholder: "Ready to help you" },
        { key: "avatar1", label: "Avatar 1", type: "image" },
        { key: "avatar2", label: "Avatar 2", type: "image" },
        { key: "avatar3", label: "Avatar 3", type: "image" },
      ],
    ...
    defaultSettings: { variant: "centered", align: "centered" },
  },
  {
    type: "stats",
    label: "Stats band",
  ...
  },
  {
    ...
    label: "Roadmap",
    icon: "🗺️",
    description: "Numbered process steps with a side panel and tab switcher",
    fields: [
      { path: "eyebrow", label: "Eyebrow (small caps)", type: "text" },
      { path: "heading", label: "Heading", type: "text" },
      { path: "subheading", label: "Subheading", type: "text" },
      { path: "image", label: "Side image (shown as a circle)", type: "image" },
      { path: "caption", label: "Caption under the image", type: "text" },
      { path: "tab1.label", label: "Tab 1 label", type: "text", placeholder: "Phone call" },
      { path: "tab1.icon", label: "Tab 1 icon (emoji)", type: "text" },
      { path: "tab2.label", label: "Tab 2 label (leave blank for no tabs)", type: "text" },
      { path: "tab2.icon", label: "Tab 2 icon (emoji)", type: "text" },
      { path: "glance.title", label: "Highlights title", type: "text", placeholder: "At a glance" },
      { path: "glance.points", label: "Highlights — one per line", type: "textarea" },
    ],
    repeater: {
      path: "steps",
      label: "Steps",
      ...
      fields: [
        ...
        { key: "track", label: "Show in tab (1, 2, or blank for both)", type: "text" },
      ],
      newItem: { icon: "", title: "New step", text: "", track: "" },
    },
    defaultContent: {
      eyebrow: "How it works",
      heading: "Your journey with us",
      subheading: "Roadmap",
      caption: "Choose how you would like to begin",
      glance: { title: "At a glance", points: "Private and secure from the first call\nMatched with the right specialist\nNo surprises on cost" },
      steps: [
        { icon: "📞", title: "Get in touch", text: "Tell us briefly what you need help with." },
        { icon: "💬", title: "Free first discussion", text: "We understand your situation and answer your questions." },
        { icon: "🤝", title: "Meet your specialist", text: "We match you with the right person for your matter." },
        { icon: "✅", title: "Move forward", text: "Agree the plan and the fee before any work begins." },
      ],
    },
  },
  {
