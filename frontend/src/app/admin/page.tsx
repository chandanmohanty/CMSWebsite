        ...
        <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-6">
          <div className="flex items-center gap-6">
            ...
            <nav className="flex items-center gap-4 text-sm">
              ...
              <a href="/admin/templates" className="text-slate-500 hover:text-slate-900">Templates</a>
          ...
          {websites?.map((site) => (
            <div key={site.id} className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                ...
                <a href={`/admin/websites/${site.id}/translations`} className="rounded-lg bg-slate-100 px-3 py-1.5 text-sm font-semibold text-slate-600 hover:bg-slate-200">
                  Translations →
                </a>
              </div>
            </div>
